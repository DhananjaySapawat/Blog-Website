...
class AllPost(APIView):
    ...
    def post(self, request):
        ...
        if(request.data["data"]["type"] == "add"):
            ...
            post_to_edit=Post.objects.get(pk=request.data["data"]["id"])
            if post_to_edit.likes.filter(id=request.data["data"]["currentid"]).exists():
                post_to_edit.likes.remove(request.data["data"]["currentid"])
            else:
                post_to_edit.likes.add(request.data["data"]["currentid"])
